...
type RepositoryInterface interface {
	...
	NewEvent(event *Event, taskID string, title string, description string) (*Event, error)
	...
	UpdateEvent(event *Event, taskID string, title string, description string) error
